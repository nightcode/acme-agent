...
public interface AcmeService {
  ...
  Account findOrRegisterAccount(Session session) throws AcmeException;

  SignedCertificateResult issueCertificate(CsrTask task) throws CertificateIssuingException;
}
